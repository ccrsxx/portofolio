import Banner from '/public/assets/blog/data-fetching-in-nextjs/banner.webp';
...
export const meta = {
  ...
  banner: Banner,
  altBanner: 'Photo by Irina Ermakova on Unsplash',
  altBannerLink: 'https://unsplash.com/photos/rIsHXq2Bvho',
  description:
